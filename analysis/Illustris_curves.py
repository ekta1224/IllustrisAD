...
for halo in halos:
	...
	#========================================================
	single_plot()
	plt.hist(star1_ad[:-1], bins=range(-300, 300, 8), label='Group 1: {} stars, AD ={}'.format(sum(group1), np.median(star1_ad[:-1])), normed=1, histtype='step', linewidth=1.6,linestyle='--',stacked=True,fill=False, color='b')
	plt.hist(star2_ad[:-1], bins=range(-300, 300, 8), label='Group 2: {} stars, AD ={}'.format(sum(group2), np.median(star2_ad[:-1])), normed=1, histtype='step', linewidth=1.6,stacked=True,fill=False, color='m', hatch='//', alpha=0.4)
	plt.hist(star3_ad[:-1], bins=range(-300, 300, 8), label='Group 3: {} stars, AD ={}'.format(sum(group3), np.median(star3_ad[:-1])), normed=1, histtype='step', linewidth=1.6,stacked=True,fill=True, color='green', alpha=0.4)
	plt.hist(star4_ad[:-1], bins=range(-300, 300, 8), label='Group 4: {} stars, AD ={}'.format(sum(group4), np.median(star4_ad[:-1])), normed=1, histtype='step', linewidth=1.6,linestyle='-',stacked=True,fill=False, color='r')
	plt.legend(loc=2, frameon=False)
	plt.xlim(-300,300)
	...
	axes[2,0].scatter(star1x, star1y, c= star1_disp, cmap='copper', s=4, vmin=0,vmax=200) 
	axes[2,0].add_artist(c2)
	axes[2,1].scatter(star2x, star2y, c= star2_disp, cmap='copper', s=4, vmin=0,vmax=200)
	axes[2,1].add_artist(c1)
	axes[2,2].add_artist(c3)
	axes[2,2].scatter(star3x, star3y, c= star3_disp, cmap='copper', s=4,vmin=0,vmax=200) 
	axes[2,3].add_artist(c7)
	im2=axes[2,3].scatter(star4x, star4y, c= star4_disp, cmap='copper', s=4,vmin=0,vmax=200)
