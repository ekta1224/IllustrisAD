...
# axes[0,0].hist(star1_AD_merger1, bins=range(-100, 150, 10), label=r'$\rm \leq 1\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star1_AD_merger1),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,linestyle='--',stacked=True,fill=False, color='b')
# axes[0,0].hist(star2_AD_merger1, bins=range(-100, 150, 10), label=r'$\rm 1-5\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star2_AD_merger1),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,stacked=True,fill=False, color='m', hatch='//', alpha=0.4)
# axes[0,0].hist(star3_AD_merger1, bins=range(-100, 150, 10), label=r'$\rm 5-10\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star3_AD_merger1),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,stacked=True,fill=True, color='green', alpha=0.4)
# axes[0,0].hist(star4_AD_merger1, bins=range(-100, 150, 10), label=r'$\rm \geq 10\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star4_AD_merger1),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,linestyle='-',stacked=True,fill=False, color='r')
# axes[0,1].hist(star1_AD_no_merger1, bins=range(-100, 150, 10), label=r'$\rm \leq 1\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star1_AD_no_merger1),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,linestyle='--',stacked=True,fill=False, color='b')
# axes[0,1].hist(star2_AD_no_merger1, bins=range(-100, 150, 10), label=r'$\rm 1-5\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star2_AD_no_merger1),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,stacked=True,fill=False, color='m', hatch='//', alpha=0.4)
# axes[0,1].hist(star3_AD_no_merger1, bins=range(-100, 150, 10), label=r'$\rm 5-10\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star3_AD_no_merger1),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,stacked=True,fill=True, color='green', alpha=0.4)
# axes[0,1].hist(star4_AD_no_merger1, bins=range(-100, 150, 10), label=r'$\rm \geq 10\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star4_AD_no_merger1),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,linestyle='-',stacked=True,fill=False, color='r')
...
# axes[1,0].hist(star1_AD_merger2, bins=range(-100, 150, 10), label=r'$\rm \leq 1\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star1_AD_merger2),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,linestyle='--',stacked=True,fill=False, color='b')
# axes[1,0].hist(star2_AD_merger2, bins=range(-100, 150, 10), label=r'$\rm 1-5\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star2_AD_merger2),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,stacked=True,fill=False, color='m', hatch='//', alpha=0.4)
# axes[1,0].hist(star3_AD_merger2, bins=range(-100, 150, 10), label=r'$\rm 5-10\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star3_AD_merger2),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,stacked=True,fill=True, color='green', alpha=0.4)
# axes[1,0].hist(star4_AD_merger2, bins=range(-100, 150, 10), label=r'$\rm \geq 10\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star4_AD_merger2),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,linestyle='-',stacked=True,fill=False, color='r')
# axes[1,1].hist(star1_AD_no_merger2, bins=range(-100, 150, 10), label=r'$\rm \leq 1\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star1_AD_no_merger2),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,linestyle='--',stacked=True,fill=False, color='b')
# axes[1,1].hist(star2_AD_no_merger2, bins=range(-100, 150, 10), label=r'$\rm 1-5\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star2_AD_no_merger2),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,stacked=True,fill=False, color='m', hatch='//', alpha=0.4)
# axes[1,1].hist(star3_AD_no_merger2, bins=range(-100, 150, 10), label=r'$\rm 5-10\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star3_AD_no_merger2),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,stacked=True,fill=True, color='green', alpha=0.4)
# axes[1,1].hist(star4_AD_no_merger2, bins=range(-100, 150, 10), label=r'$\rm \geq 10\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star4_AD_no_merger2),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,linestyle='-',stacked=True,fill=False, color='r')
# axes[1,0].legend(loc=1, frameon=False, fontsize=10)
# axes[1,1].legend(loc=1, frameon=False)
# axes[1,0].annotate('Recent (9.4 Gyrs) 4:1', xy=(-105, 0.057), horizontalalignment='left', fontsize=13)
...
# axes[2,0].hist(star1_AD_merger3, bins=range(-100, 150, 10), label=r'$\rm \leq 1\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star1_AD_merger3),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,linestyle='--',stacked=True,fill=False, color='b')
# axes[2,0].hist(star2_AD_merger3, bins=range(-100, 150, 10), label=r'$\rm 1-5\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star2_AD_merger3),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,stacked=True,fill=False, color='m', hatch='//', alpha=0.4)
# axes[2,0].hist(star3_AD_merger3, bins=range(-100, 150, 10), label=r'$\rm 5-10\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star3_AD_merger3),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,stacked=True,fill=True, color='green', alpha=0.4)
# axes[2,0].hist(star4_AD_merger3, bins=range(-100, 150, 10), label=r'$\rm \geq 10\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star4_AD_merger3),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,linestyle='-',stacked=True,fill=False, color='r')
# axes[2,1].hist(star1_AD_no_merger3, bins=range(-100, 150, 10), label=r'$\rm \leq 1\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star1_AD_no_merger3),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,linestyle='--',stacked=True,fill=False, color='b')
# axes[2,1].hist(star2_AD_no_merger3, bins=range(-100, 150, 10), label=r'$\rm 1-5\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star2_AD_no_merger3),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,stacked=True,fill=False, color='m', hatch='//', alpha=0.4)
# axes[2,1].hist(star3_AD_no_merger3, bins=range(-100, 150, 10), label=r'$\rm 5-10\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star3_AD_no_merger3),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,stacked=True,fill=True, color='green', alpha=0.4)
# axes[2,1].hist(star4_AD_no_merger3, bins=range(-100, 150, 10), label=r'$\rm \geq 10\ Gyr,\ \overline{v_{a}}$' + r'$={}$'.format(round(np.median(star4_AD_no_merger3),2)) + r'$\rm \ km \ s^{-1}$', density=True, histtype='step', linewidth=1.6,linestyle='-',stacked=True,fill=False, color='r')
...
axes[0,0].annotate('Recent (4 Gyrs) 4:1 Merger', xy=(5, 205), horizontalalignment='left', fontsize=13)
axes[0,1].annotate('No Recent 4:1 Merger', xy=(5, 205), horizontalalignment='left', fontsize=13)
axes[0,0].annotate('{} Halos'.format(num_mergers1), xy=(5, 195), horizontalalignment='left', fontsize=13)
axes[0,1].annotate('{} Halos'.format(num_no_mergers1), xy=(5, 195), horizontalalignment='left', fontsize=13)
...
axes[1,0].annotate('Recent (9.4 Gyrs) 4:1 Merger', xy=(5, 205), horizontalalignment='left', fontsize=13)
axes[1,1].annotate('No Recent 4:1 Merger', xy=(5, 205), horizontalalignment='left', fontsize=13)
axes[1,0].annotate('{} Halos'.format(num_mergers2), xy=(5, 195), horizontalalignment='left', fontsize=13)
axes[1,1].annotate('{} Halos'.format(num_no_mergers2), xy=(5, 195), horizontalalignment='left', fontsize=13)
...
axes[2,0].annotate('Recent (12 Gyrs) 4:1 Merger', xy=(5, 205), horizontalalignment='left', fontsize=13)
axes[2,1].annotate('No Recent 4:1 Merger', xy=(5, 205), horizontalalignment='left', fontsize=13)
axes[2,0].annotate('{} Halos'.format(num_mergers3), xy=(5, 195), horizontalalignment='left', fontsize=13)
axes[2,1].annotate('{} Halos'.format(num_no_mergers3), xy=(5, 195), horizontalalignment='left', fontsize=13)
