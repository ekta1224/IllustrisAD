...
merger_data = h5py.File('merger_history_099.hdf5', 'r')
...
#save file
np.savetxt('/Volumes/Titan/analogs/TNGdata/M31analogs_merger_props_TNG100_revised.txt', np.c_[revised_ids, last_major_time, num_major, num_minor], header='snapshot number of last major merger, number of total major mergers, number of total minor mergers')
